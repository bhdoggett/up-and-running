...
import { migrateState } from "./types";
...
export async function loadState(): Promise<AppState> {
  ...
  // Anything previously saved — with or without projects — migrates forward.
  if (saved && (Array.isArray(saved.projects) || Array.isArray(saved.checklists))) {
